...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    CanvasElement_CanvasElement(height, width) {
      ...
      B.CanvasElement_methods.set$width(e, width);
      B.CanvasElement_methods.set$height(e, height);
      return e;
    },
    ...
    drawVortex(multiplier, modulus) {
      var t2, i, t3, colorIndex, indices, first, n, t4, t5, index, every,
        _s9_ = "slateblue",
        x = new A.drawVortex_closure(modulus),
        y = new A.drawVortex_closure0(modulus),
        t1 = $.$get$bufferContext();
      t1.save();
      B.CanvasRenderingContext2D_methods.set$fillStyle(t1, "white");
      t1.fillRect(0, 0, 800, 800);
      t1.translate(400, 400);
      t1 = A.LinkedHashSet_LinkedHashSet$_empty(type$.int);
      for (t2 = modulus - 1, i = 0; i < t2;) {
        ++i;
        t1.add$1(0, i);
      }
      for (t2 = t1.$ti._precomputed1, t3 = type$.JSArray_int, colorIndex = 0; t1._collection$_length > 0;) {
        $.$get$bufferContext().beginPath();
        indices = A._setArrayType([], t3);
        first = t1._first;
        if (first == null)
          A.throwExpression(A.StateError$("No elements"));
        n = t2._as(first._element);
        for (; !B.JSArray_methods.contains$1(indices, n);) {
          B.JSArray_methods.add$1(indices, n);
          t1.remove$1(0, n);
          n = B.JSInt_methods.$mod(n * multiplier, modulus);
        }
        t4 = $.$get$bufferContext();
        (t4 && B.CanvasRenderingContext2D_methods).set$strokeStyle(t4, _s9_);
        t4.lineWidth = 1;
        if (0 >= indices.length)
          return A.ioore(indices, 0);
        t5 = x.call$2(360, indices[0]);
        if (0 >= indices.length)
          return A.ioore(indices, 0);
        B.CanvasRenderingContext2D_methods.moveTo$2(t4, t5, y.call$2(360, indices[0]));
        ++colorIndex;
        for (i = 1; t5 = indices.length, i < t5; ++i) {
          index = indices[B.JSInt_methods.$mod(i, t5)];
          B.CanvasRenderingContext2D_methods.lineTo$2(t4, x.call$2(360, index), y.call$2(360, index));
        }
        t4.closePath();
        t4.stroke();
      }
      t1 = $.$get$bufferContext();
      (t1 && B.CanvasRenderingContext2D_methods).set$strokeStyle(t1, "lightgray");
      t1.beginPath();
      t1.arc(0, 0, 360, 0, 6.283185307179586, false);
      t1.stroke();
      every = B.JSInt_methods._tdivFast$1(modulus, 50);
      for (t2 = every !== 0, i = 0; i < modulus; ++i) {
        if (!t2 || B.JSInt_methods.$mod(i, every) === 0) {
          t1.font = "12pt Arial";
          t1.textAlign = "center";
          t1.textBaseline = "middle";
          B.CanvasRenderingContext2D_methods.set$fillStyle(t1, "darkgray");
          t3 = x.call$2(380, i);
          t4 = y.call$2(392, i);
          t1.fillText("" + i, A._asNum(t3), A._asNum(t4));
        }
        B.CanvasRenderingContext2D_methods.set$fillStyle(t1, _s9_);
        t1.beginPath();
        t3 = x.call$2(360, i);
        t4 = y.call$2(360, i);
        t1.arc(A._asNum(t3), A._asNum(t4), 3, 0, 6.283185307179586, false);
        t1.fill();
      }
      t1.restore();
      $.$get$canvasContext().drawImage($.$get$buffer(), 0, 0);
    },
    main() {
      var t3, t4,
        t1 = document,
        t2 = type$.InputElement,
        multiplierInput = t2._as(t1.querySelector("#multiplier")),
        multiplierValue = t2._as(t1.querySelector("#multiplier-value")),
        modulusInput = t2._as(t1.querySelector("#modulus")),
        modulusValue = t2._as(t1.querySelector("#modulus-value"));
      type$.DivElement._as(t1.querySelector("#output")).appendChild(type$.Element._as($.$get$canvas()));
      t1 = new A.main_updateDrawing(multiplierValue, multiplierInput, modulusValue, modulusInput);
      t2 = type$._ElementEventStreamImpl_Event;
      t3 = t2._eval$1("~(1)?");
      t4 = t3._as(new A.main_closure(t1));
      type$.nullable_void_Function._as(null);
      t2 = t2._precomputed1;
      A._EventStreamSubscription$(multiplierInput, "input", t4, false, t2);
      A._EventStreamSubscription$(multiplierValue, "change", t3._as(new A.main_closure0(multiplierInput, multiplierValue, t1)), false, t2);
      A._EventStreamSubscription$(modulusInput, "input", t3._as(new A.main_closure1(t1)), false, t2);
      A._EventStreamSubscription$(modulusValue, "change", t3._as(new A.main_closure2(modulusInput, modulusValue, t1)), false, t2);
      t1.call$0();
    },
    drawVortex_closure: function drawVortex_closure(t0) {
      this.modulus = t0;
    },
    drawVortex_closure0: function drawVortex_closure0(t0) {
      this.modulus = t0;
    },
    main_updateDrawing: function main_updateDrawing(t0, t1, t2, t3) {
      var _ = this;
      _.multiplierValue = t0;
      _.multiplierInput = t1;
      _.modulusValue = t2;
      _.modulusInput = t3;
    },
    main_closure: function main_closure(t0) {
      this.updateDrawing = t0;
    },
    main_closure0: function main_closure0(t0, t1, t2) {
      this.multiplierInput = t0;
      this.multiplierValue = t1;
      this.updateDrawing = t2;
    },
    main_closure1: function main_closure1(t0) {
      this.updateDrawing = t0;
    },
    main_closure2: function main_closure2(t0, t1, t2) {
      this.modulusInput = t0;
      this.modulusValue = t1;
      this.updateDrawing = t2;
    },
  ...
  A.drawVortex_closure.prototype = {
    call$2(r, index) {
      return B.JSNumber_methods.toInt$0(r * Math.cos(index * 3.141592653589793 * 2 / this.modulus - 1.5707963267948966));
    },
    $signature: 4
  };
  A.drawVortex_closure0.prototype = {
    call$2(r, index) {
      return B.JSNumber_methods.toInt$0(r * Math.sin(index * 3.141592653589793 * 2 / this.modulus - 1.5707963267948966));
    },
    $signature: 4
  };
  A.main_updateDrawing.prototype = {
    call$0() {
      var t2, sMultiplier, sModulus, multiplier, modulus, _this = this,
        t1 = _this.multiplierInput;
      B.InputElement_methods.set$value(_this.multiplierValue, A.S(t1.value));
      t2 = _this.modulusInput;
      B.InputElement_methods.set$value(_this.modulusValue, A.S(t2.value));
      sMultiplier = t1.value;
      sModulus = t2.value;
      if (sMultiplier != null && sModulus != null) {
        multiplier = A.Primitives_parseInt(sMultiplier, null);
        modulus = A.Primitives_parseInt(sModulus, null);
        if (multiplier != null && modulus != null)
          A.drawVortex(multiplier, modulus);
      }
    },
    $signature: 0
  };
  A.main_closure.prototype = {
    call$1($event) {
      this.updateDrawing.call$0();
    },
    $signature: 1
  };
  A.main_closure0.prototype = {
    call$1($event) {
      B.InputElement_methods.set$value(this.multiplierInput, this.multiplierValue.value);
      this.updateDrawing.call$0();
    },
    $signature: 1
  };
  ...
  A.main_closure2.prototype = {
    call$1($event) {
      B.InputElement_methods.set$value(this.modulusInput, this.modulusValue.value);
      this.updateDrawing.call$0();
    },
    $signature: 1
  };
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.ListIterator, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A._StackTrace, A.Closure, A.Rti, A._FunctionParameters, A._TimerImpl, A.AsyncError, A._FutureListener, A._Future, A._AsyncCallbackEntry, A.Stream, A.StreamSubscription, A._Zone, A.__SetBase_Object_SetMixin, A._LinkedHashSetCell, A._LinkedHashSetIterator, A.ListMixin, A.SetMixin, A.StackOverflowError, A._Exception, A.Null, A._StringStackTrace, A.StringBuffer, A.EventStreamProvider, A.ImmutableListMixin, A.FixedSizeListIterator]);
    _inheritMany(J.Interceptor, [J.JSBool, J.JSNull, J.JavaScriptObject, J.JSArray, J.JSNumber, J.JSString]);
    _inheritMany(J.JavaScriptObject, [J.LegacyJavaScriptObject, A.EventTarget, A.CanvasRenderingContext2D, A.DomException, A.Event, A._HtmlCollection_JavaScriptObject_ListMixin]);
    ...
    _inheritMany(A.Closure2Args, [A.initHooks_closure0, A.drawVortex_closure, A.drawVortex_closure0]);
    _inherit(A._TypeError, A._Error);
    _inheritMany(A.Closure0Args, [A._AsyncRun__scheduleImmediateJsOverride_internalCallback, A._AsyncRun__scheduleImmediateWithSetImmediate_internalCallback, A._TimerImpl_internalCallback, A._Future__addListener_closure, A._Future__prependListeners_closure, A._Future__propagateToListeners_handleWhenCompleteCallback, A._Future__propagateToListeners_handleValueCallback, A._Future__propagateToListeners_handleError, A.Stream_length_closure0, A._rootHandleError_closure, A._RootZone_bindCallbackGuarded_closure, A.main_updateDrawing]);
    ...
    _inheritMany(A.HtmlElement, [A.AnchorElement, A.AreaElement, A.CanvasElement, A.DivElement, A.FormElement, A.InputElement, A.SelectElement]);
...
;
  ...
  (function lazyInitializers() {
    ...
    _lazyFinal($, "canvas", "$get$canvas", () => A.CanvasElement_CanvasElement(800, 800));
    _lazyFinal($, "buffer", "$get$buffer", () => A.CanvasElement_CanvasElement(800, 800));
    _lazyFinal($, "canvasContext", "$get$canvasContext", () => {
      var t1 = $.$get$canvas();
      return (t1 && B.CanvasElement_methods).get$context2D(t1);
    });
    _lazyFinal($, "bufferContext", "$get$bufferContext", () => {
      var t1 = $.$get$buffer();
      return (t1 && B.CanvasElement_methods).get$context2D(t1);
    });
  })();
